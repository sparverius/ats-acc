...
fn(*{}*)
generic_simplify
(x0: token, xs0: toks, insert: string): void
...
fn(*{}*)
simplify_S2Ecst
(x0: token, xs0: toks): (toks, toks)
(* 
helper
*)  
fn(*{}*)
simplify_S2Eext
(x0: token, xs0: toks): toks
(*
| S2Eextype of (string(*name*), s2explstlst) // external type
*)
fn(*{}*)
simplify_S2Eextype
(x0: token, xs0: toks): toks //= simplify_S2ext(x0, xs0)
(*
...
fn(*{}*)
simplify_S2Evar
(x0: token, xs0: toks): (toks, toks, toks)
(*
...
fn(*{}*)
simplify_S2Eapp
(x0: token, xs0: toks): (toks, toks, toks, toks, toks)
(*
...
fn(*{}*)
simplify_S2Efun
(x0: token, xs: toks): (toks, toks, toks, toks, toks)
(*
